...
-(void)setSubView:(UITextField *)subView
{
    _subView = subView;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    day = i - firstWeekday + 1;
    if (self.subView)
        self.subView.text = [NSString stringWithFormat:@"%li-%.2ld-%.2li",(long)[comp year],(long)[comp month],(long)day];
...
- (IBAction)todayAction:(UIButton *)sender
{
    ...
    if (self.subView)
        self.subView.text = [self formatterData:currentDate];
    [self hide];
}
...
-(NSString *)formatterData:(NSDate *)currentDate
{
